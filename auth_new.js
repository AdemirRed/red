...
async function login(username, password) {
  try {
    ...
    const userResult = await db.query(
      'SELECT id, username, email, password_hash, full_name, is_admin, is_premium, is_active, failed_login_attempts, locked_until FROM users WHERE username = $1 OR email = $1',
      [username]
    );
